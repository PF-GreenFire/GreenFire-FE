...
import ChallengeHeader from "../../components/mypage/ChallengeHeader";
import ChallengeTabs from "../../components/mypage/ChallengeTabs";
...
const ChallengeMain = () => {
  ...
  const tempChallenges = [
    { id: 1, title: "플로깅 챌린지", type: "가연핑", imageUrl: "https://picsum.photos/200?random=1" },
    { id: 2, title: "플라스틱 없는 삶", type: "시온핑", imageUrl: "https://picsum.photos/200?random=2" },
    { id: 3, title: "우리의 힘", type: "예원핑", imageUrl: "https://picsum.photos/200?random=3" },
    { id: 4, title: "플로깅 챌린지2", type: "가연핑", imageUrl: "https://picsum.photos/200?random=4" },
    { id: 5, title: "플라스틱 없는 삶2", type: "시온핑", imageUrl: "https://picsum.photos/200?random=5" },
    { id: 6, title: "우리의 힘2", type: "예원핑", imageUrl: "https://picsum.photos/200?random=6" },
    { id: 7, title: "플로깅 챌린지3", type: "가연핑", imageUrl: "https://picsum.photos/200?random=7" },
    { id: 8, title: "플라스틱 없는 삶3", type: "시온핑", imageUrl: "https://picsum.photos/200?random=8" },
    { id: 9, title: "우리의 힘3", type: "예원핑", imageUrl: "https://picsum.photos/200?random=9" },
  ];

  // Redux 데이터가 없으면 임시 데이터 사용
  const challenges = challengeData?.challenges?.length > 0
  ...
  return (
    <>
      <ChallengeHeader username={username} onGoBack={handleGoBack} />
      <ChallengeTabs activeTab={activeTab} onTabClick={handleTabClick} />
